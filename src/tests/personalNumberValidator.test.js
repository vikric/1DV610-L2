...
test('returns false when the last 4 digits are incorrect', () => {
  const result = validator.validateSwedishPersonalNumber('9005121244')
  expect(result.valid).toBe(false)
